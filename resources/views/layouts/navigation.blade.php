<nav x-data="{ open: false }" class="bg-white/10 backdrop-blur-md border-b border-white/20 shadow-glass-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="iridescent-text font-bold text-xl">
                        {{ config('app.name') }}
                    </a>
                </div>
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-300 hover:text-gray-200 hover:bg-white/10 focus:outline-none focus:bg-white/10 focus:text-gray-200 transition duration-150 ease-in-out">
