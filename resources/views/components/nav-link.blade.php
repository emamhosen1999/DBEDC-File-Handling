...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#ff5cf7] text-sm font-medium leading-5 text-white focus:outline-none focus:border-[#ff5cf7] transition duration-150 ease-in-out'
